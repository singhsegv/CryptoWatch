...
import io.github.rajdeep1008.cryptowatch.activity.DetailActivity;
import io.github.rajdeep1008.cryptowatch.activity.MainActivity;
import io.github.rajdeep1008.cryptowatch.activity.SetWatchActivity;
...
public class CryptoAdapter extends RecyclerView.Adapter<CryptoAdapter.ViewHolder> {
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public void showDetails() {
            ...
            intent.putExtra("crypto", currentItem);
            ((MainActivity) mContext).startActivityForResult(intent, 007);
        }
            ...
            builder.setItems(menuItems, new DialogInterface.OnClickListener() {
                ...
                public void onClick(DialogInterface dialogInterface, int i) {
                    if (i == 0) {
                        ...
                        Intent intent = new Intent(mContext, SetWatchActivity.class);
                        intent.putExtra("crypto", currentItem);
                        ((MainActivity) mContext).startActivityForResult(intent, 1008);
                    }
                }
            });
